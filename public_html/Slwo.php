    ...
    class Slwo {
        ...
        public function sort($sort) {
            ...
            if (in_array($sort, $_)) {
                ...
                trigger_error('The sort parameters must be one of the following: ' . implode($_, ', ') .
        ...
        public function output() {
             ...
             * Get the words.
             */
            preg_match_all('/([a-zA-Z]|\xC3[\x80-\x96\x98-\xB6\xB8-\xBF]|\xC5[\x92\x93\xA0\xA1\xB8\xBD\xBE]){4,}/', $contents, $occurrences);
